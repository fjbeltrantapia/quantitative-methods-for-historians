...
We will be therefore download and install both software (**R** and **RStudio**) in your computer. Here are the links to download them: [R](https://cloud.r-project.org) and [RStudio IDE](https://posit.co/download/rstudio-desktop) to access them. The version you install depends on whether you are using Windows or Mac.
