...
- [Hansard dataset](https://hansard.parliament.uk/about): UK Parliamentary speeches between 1806 and 1911 (over 1 million parliamentary speeches). This is a huge dataset that might be computationally too demanding on some machines. Find <a href="data/other-data/hansard/hansard_sample.csv" download>here</a> a random sample of 10,000 speeches. See @blaxill2020 and @guldi2023 for illustrations using this information.
...
The [National Biblioteket](https://www.nb.no/search) has million of digitised resources (books, manuscripts, newspapers, letters, etc.). If you are interested on a particular period, you can contact them and request a particular corpus. The [DH-LAB](https://www.nb.no/dh-lab/digital-tekstanalyse/) at the National Biblioteket is also creating its own tools for accessing and analysing their corpuses (including R packages). 
