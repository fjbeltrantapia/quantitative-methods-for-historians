...
September TBA, 2026 -- 09:15-16:00 -- Room TBA ([Akrinn](https://maps.app.goo.gl/neGSMmi15nzrfNyr5), Kalvskinnet)
...
::: {.column-margin}  
![State of the Union Presidential Address - Woodrow Wilson - December 2, 1913](images/wilson.jpg){width=100% height=100% fig-align="center"}

![Relative frequency of the terms "men" and "women" in the State of the Union Speeches, 1790-2019](images/plot-speeches.png){width=100% height=100%} 
:::
